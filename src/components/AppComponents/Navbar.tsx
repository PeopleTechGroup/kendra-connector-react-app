...
const NavBar = () => {
  ...
  const [indexExpand, setIndexExpand] = React.useState(true);
  ...
  const handleIndicesExpand = () => {
    setIndexExpand(!indexExpand);
  };
  ...
  return (
    <div className={classes.grow}>
      <AppBar position="static">
        ...
        {/* The Toolbar with items to be visible in the home page header */}
      </AppBar>{" "}
      {/* The Appbar in the home page header */}
      <Drawer
        open={isDrawerOpen}
      ...
      >
        <List>
          {" "}
          {/* The Drawer to pop-out of the hamburger menu */}
